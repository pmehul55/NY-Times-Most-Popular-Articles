...
class DetailViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
         ...
         if indexPath.row == 0{
            ...
            let cell = tableView.dequeueReusableCell(withIdentifier: "detailCell1", for: indexPath)
            ...
            if let imageView = cell.viewWithTag(1001) as? UIImageView{
                ...
                if let casheImage = parentController.imageCache.object(forKey: resultDetails.media[0].mediaMetadata[0].url) as? UIImage{
                    ...
                    parentController.downloadImage(from: resultDetails.media[0].mediaMetadata[0].url, imgViewRef: imageView)
                }
            }
           return cell
        }
